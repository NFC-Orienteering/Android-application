	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(nfcAdapter == null){
			...
			if(!nfcAdapter.isEnabled()){
				Toast.makeText(this, "Your NFC-reader is disabled. Enable NFC-reader to continue", Toast.LENGTH_LONG).show();
	...
	class NdefReaderTask extends AsyncTask<Tag, Void, String> {
	    ...
	    private String readText(NdefRecord record) throws UnsupportedEncodingException {
	        ...
	        return new String(payload,
	        		languageCodeLength + 1, payload.length - languageCodeLength - 1, textEncoding);
	    }
